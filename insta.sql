...
CREATE TABLE hashtags (
	id SERIAL PRIMARY KEY,
	hashtag character varying(128) PRIMARY KEY,
	reps int DEFAULT 0
);
...
CREATE TABLE ToHash (
	...
	post_id bigint NOT NULL,
	is_com bool DEFAULT 0,
	is_post bool DEFAULT 0,
	hashtag character varying(128) NOT NULL,
	UNIQUE (com_id, hashtag)
);
...
ALTER TABLE ToHash
	ADD FOREIGN KEY (hashtag) REFERENCES hashtags(hashtag);
